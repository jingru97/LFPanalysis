...
sessionno="session01";
arrayname="array02";
sessiondate={'20181017','20180917','20180807','20181001'};
channel=10;
% 
...
for sessionname=sessiondate
    ...
    cd (strcat('/Volumes/Hippocampus/Data/picasso-misc/',sessionname,'/',sessionno,""));
    ...
    cd (strcat('/Volumes/Hippocampus/Data/picasso-misc/',sessionname,'/',sessionno,'/',arrayname,"/",channelname,""));
